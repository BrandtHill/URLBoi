defmodule UrlboiWeb.ShortUrlControllerTest do
  use UrlboiWeb.ConnCase

  alias Urlboi.ShortUrls
  alias Urlboi.ShortUrls.ShortUrl

  @create_attrs %{
    shortpath: "some shortpath",
    url: "some url"
  }
  @update_attrs %{
    shortpath: "some updated shortpath",
    url: "some updated url"
  }
  @invalid_attrs %{shortpath: nil, url: nil}

  def fixture(:short_url) do
    {:ok, short_url} = ShortUrls.create_short_url(@create_attrs)
    short_url
  end
